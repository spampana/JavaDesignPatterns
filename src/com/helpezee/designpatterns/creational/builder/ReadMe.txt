...
different setter methods to set the optional parameters. 
...
Java Builder class should have methods to set the optional parameters and it should return the same Builder object after setting 
